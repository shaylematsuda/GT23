...
# This is for making the qPCR plate layouts for ONLY Mcap and Acer
```{r}
#these include the antibiotics. they do not include sterivex

#create ACER subset: 
Acer<-subset(merged_df, species=="Acer") #355 samples
...
Mcap<-subset(merged_df, species=="Mcap") #345 samps
